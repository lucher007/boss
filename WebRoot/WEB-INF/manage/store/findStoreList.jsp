        ...
        <form action="" method="post" id="searchForm" name="searchForm">
            <table width="100%">
				<tr>
					...
					<td align="right">
						<%-- 
						<input type="button" class="btn-sch" value="<spring:message code="page.query"/>" onclick="queryStore();"/>
						 --%>
						<a href="javascript:queryStore();" class="easyui-linkbutton" iconCls="icon-search" style="width:80px"><spring:message code="page.query"/></a>
					</td>
					<td width="130px">
						<%-- 
						<input type="button" class="btn-add" value="<spring:message code="page.add"/>" onclick="addStore();"/>
						 --%>
						<a href="javascript:addStore();" class="easyui-linkbutton" iconCls="icon-add" style="width:80px"><spring:message code="page.add"/></a>
					</td>
				</tr>
    	    </table>
   		</form>
