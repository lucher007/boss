...
<body style="padding:0px; width:99%; ">
				...
				<table width="100%">
					...
					<tr height="25px">
						...
						<td><input type="text" id="endtime" name="endtime" value="${endtime }"
							onfocus="WdatePicker({lang:'${locale}',skin:'blueFresh',isShowWeek:true,isShowClear:true,dateFmt:'yyyy-MM-dd  HH:mm:ss',minDate:'#F{$dp.$D(\'starttime\');}'});"
							class="Wdate inp w150" value="${caspnforcedcc.endtime}" />
						</td>
					</tr>
					<tr height="25px">
						<td align="right"><spring:message code="authorize.forcedcc.serviceid"/>：</td>
						<td>
					          <input type="text" class="inp" name="serviceid" id="serviceid" value="${caspnforcedcc.serviceid}"  onkeyup="checkNum(this)" onkeypress="checkNum(this)" onblur="checkNum(this)" maxlength="5" onafterpaste="this.value=this.value.replace(/\D/g,'')" /> 
						</td>
						<td align="right"><spring:message code="authorize.forcedcc.tsid"/>：</td>
						<td>
					          <input type="text" class="inp" name="tsid" id="tsid" value="${caspnforcedcc.tsid}" onkeyup="checkNum(this)" onkeypress="checkNum(this)" onblur="checkNum(this)" maxlength="5" onafterpaste="this.value=this.value.replace(/\D/g,'')" /> 
						</td>
					</tr>
					<tr height="25px">
						...
						<td>
							<select id="network_match" name="network_match" class="select" style="width:157px;">
									<option value="0" <c:if test="${caspnforcedcc.network_match== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.match.0"/></option>
									<option value="1" <c:if test="${caspnforcedcc.network_match== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.match.1"/></option>
 							</select>
						</td>
						
						<td align="right"><spring:message code="authorize.forcedcc.network_id"/>：</td>
						<td>
					          <input type="text" class="inp" name="network_id" id="network_id" value="${caspnforcedcc.network_id}" onkeyup="checkNum(this)" onkeypress="checkNum(this)" onblur="checkNum(this)" maxlength="5" onafterpaste="this.value=this.value.replace(/\D/g,'')" /> 
						</td>
					</tr>
					<tr height="25px">
						...
						<td>
							<select id="operator_match" name="operator_match" class="select" style="width:157px;">
									<option value="0" <c:if test="${caspnforcedcc.operator_match== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.match.0"/></option>
									<option value="1" <c:if test="${caspnforcedcc.operator_match== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.match.1"/></option>
 							</select>
						</td>
						
						<td align="right"><spring:message code="authorize.forcedcc.operator_id"/>：</td>
						<td>
					          <input type="text" class="inp" name="operator_id" id="operator_id" value="${caspnforcedcc.operator_id}" onkeyup="checkNum(this)" onkeypress="checkNum(this)" onblur="checkNum(this)" maxlength="5" onafterpaste="this.value=this.value.replace(/\D/g,'')" /> 
						</td>
					</tr>
					<tr height="25px">
						...
						<td>
							<select id="area_match" name="area_match" class="select" style="width:157px;">
									<option value="0" <c:if test="${caspnforcedcc.area_match== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.match.0"/></option>
									<option value="1" <c:if test="${caspnforcedcc.area_match== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.match.1"/></option>
 							</select>
						</td>
						
						<td align="right"><spring:message code="authorize.forcedcc.area_id"/>：</td>
						<td>
					          <input type="text" class="inp" name="area_id" id="area_id" value="${caspnforcedcc.area_id}" onkeyup="checkNum(this)" onkeypress="checkNum(this)" onblur="checkNum(this)" maxlength="5" onafterpaste="this.value=this.value.replace(/\D/g,'')" /> 
						</td>
					</tr>
					<tr height="25px">
						...
						<td>
							<select id="device_type_match" name="device_type_match" class="select" style="width:157px;">
									<option value="0" <c:if test="${caspnforcedcc.device_type_match== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.match.0"/></option>
									<option value="1" <c:if test="${caspnforcedcc.device_type_match== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.match.1"/></option>
 							</select>
						</td>
						...
						<td>
					          <select id="device_type" name="device_type" class="select" style="width:157px;">
									<option value="0" <c:if test="${caspnforcedcc.device_type== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.device_type.0"/></option>
									<option value="1" <c:if test="${caspnforcedcc.device_type== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.device_type.1"/></option>
 							</select> 
						</td>
					</tr>
					<tr height="25px">
						...
						<td>
							<select id="terminal_type_match" name="terminal_type_match" class="select" style="width:157px;">
									<option value="0" <c:if test="${caspnforcedcc.terminal_type_match== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.match.0"/></option>
									<option value="1" <c:if test="${caspnforcedcc.terminal_type_match== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.match.1"/></option>
 							</select>
						</td>
						...
						<td>
					          <select id="terminal_type" name="terminal_type" class="select" style="width:157px;">
									<option value="0" <c:if test="${caspnforcedcc.terminal_type== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.terminal_type.0"/></option>
									<option value="1" <c:if test="${caspnforcedcc.terminal_type== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.terminal_type.1"/></option>
 							</select> 
						</td>
					</tr>
					<tr height="25px">
						...
						<td>
							<select id="vip_class_match" name="vip_class_match" class="select" style="width:157px;">
									<option value="0" <c:if test="${caspnforcedcc.vip_class_match== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.match.0"/></option>
									<option value="1" <c:if test="${caspnforcedcc.vip_class_match== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.match.1"/></option>
 							</select>
						</td>
						
						<td align="right"><spring:message code="authorize.forcedcc.vip_class"/>：</td>
						<td>
					         <input type="text" class="inp" name="vip_class" id="vip_class" value="${caspnforcedcc.area_id}" onkeyup="checkNum(this)" onkeypress="checkNum(this)" onblur="checkNum(this)" maxlength="5" onafterpaste="this.value=this.value.replace(/\D/g,'')" />
						</td>
					</tr>
					<tr>
						<td align="right" width="120px"><spring:message code="forcedcc.lock"/>：</td>
						<td>
	...
	<script type="text/javascript">
		function goSend() {
			...
			if ($('#tsid').val() < 1 || $('#tsid').val() > 65535) {
				$.dialog.tips('<spring:message code="forcedcc.tisid.range"/>',1, 'alert.gif');
				$('#serviceid').focus();
				return;
			}
			...
			if ($('#tsid').val() == '') {
				$.dialog.tips('<spring:message code="authorize.tsid.empty"/>', 1,
						'alert.gif');
				$('#tsid').focus();
				return;
			}
