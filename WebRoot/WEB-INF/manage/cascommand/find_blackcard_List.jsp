			...
			<form action="" method="post" id="searchForm" name="searchForm">
				<table width="100%">
					...
					<tr>
						  ...
						  <td>
						  	<input type="text" id="querydate" name="querydate" value="${caspnblackcard.querydate}" onfocus="WdatePicker({lang:'${locale}',skin:'blueFresh',isShowWeek:true,isShowClear:true,dateFmt:'yyyy-MM-dd'});" class="Wdate inp w150" />
						  </td>
						  <td width="130px" colspan="3" align="right">
						  	<%-- 
