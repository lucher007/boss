...
<body style="padding:0px; width:99%; ">
	<div id="body"  class="form-box">
		...
		<div class="easyui-panel" title="<spring:message code="productplay.productinfo.add"/>" style="width:100%">
			...
			<div style="text-align:center;padding:5px">
				<a href="javascript:void(0)" class="easyui-linkbutton" onclick="addConditionProduct()"><spring:message code="productplay.productinfo.add"/></a> 
			</div>
	...
	<script type="text/javascript">
		function goSend() {
			...
			$("#paramForm").attr("action", "cascommand/send_productplaylimit");
			$("#paramForm").submit();
		}
		...
		function addConditionProduct() {
			...
			var conditionToAppend = '<tr height="20px" class="commandpartprocudt"><td align="center">'
					+ productID
		...
		function updateFinalCommand1() {
			...
			$(".commandpartprocudt").each(function() {
				var dataarray = $(this).find(".cndpara");
				var cmd = "";
				dataarray.each(function() {
					cmd = cmd + $(this).val()+",";
