			...
			<table>
				...
				<tr height="40px">
					...
					<td align="left">	              
						...
						maxlength="8"
						value="${caCommandParam.stbno }" maxlength="8"
				...
				<tr height="40px">
					...
					<td align="left">	              
						<input type="text" class="inp w200" name="pin_code" id="pin_code" value="${caCommandParam.pin_code }" onkeyup="checkNum(this)" onkeypress="checkNum(this)" onblur="checkNum(this)" onafterpaste="this.value=this.value.replace(/\D/g,'')">
							<span class="red"> *</span>
					</td>
				</tr>
				...
				<tr height="40px">
					...
					<td align="left">	              
						<input type="text" id="expired_Time" name="expired_Time" readonly="readonly" value="${caCommandParam.expired_Time }" onclick="WdatePicker({lang:'${locale}',skin:'blueFresh',isShowWeek:true,isShowClear:true,dateFmt:'yyyy-MM-dd HH:mm:ss'});" class="Wdate inp w150"/>
						<span class="red"> *</span>
					</td>
				</tr>
	...
	<script type="text/javascript">
		...
		function goSend() {
			...
			if ($('#pin_code').val().length != 6) {
				$.dialog.tips('<spring:message code="card.pincode.range"/>',1, 'alert.gif');
				return;
			}
