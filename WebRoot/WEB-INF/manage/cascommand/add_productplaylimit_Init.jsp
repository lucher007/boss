...
<body>
	<div class="form-box">
	  <form method="post" id="paramForm" name="paramForm">
	    <div class="cur-pos"><spring:message code="page.currentlocation" />：<spring:message code="menu.authorize.manage" />&gt;<spring:message code="menu.authorize.productplaylimit"/></div>
	    <div class="fb-con">
	      <div class="cur-pos">
	...
	<script type="text/javascript">
		...
		function changeVersiontype() {
		    $("#productplay").attr("src","<%=request.getContextPath()%>/cascommand/add_productplaylimit_Info?versiontype=" + $('#versiontype').val());
		}
