...
<body>
	<div class="form-box">
	  <form method="post" id="paramForm" name="paramForm">
	    <div class="cur-pos"><spring:message code="page.currentlocation" />：<spring:message code="menu.authorize.manage" />&gt;<spring:message code="menu.authorize.parentlock"/></div>
	    <div class="fb-con">
	      <div class="cur-pos">
...
<!-- 		                <option value="gos_pn" <c:if test="${CaCommandParam.versiontype == 'gos_pn' }">selected</c:if>><spring:message code="server.versiontype.gos_pn"/></option> -->
	      ...
	      <div id="info">
	      	<iframe id="parentlock" scrolling="auto" frameborder="0" style="width:100%;height:580px;"></iframe>
	      </div>
	       </form>
	    </div>
	    <!--
	...
	<script type="text/javascript">
		...
		function changeVersiontype() {
		    $("#parentlock").attr("src","<%=request.getContextPath()%>/cascommand/add_parentlock_Info?versiontype=" + $('#versiontype').val());
		}
