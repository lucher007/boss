				...
				<table width="100%">
					...
					<td height="30" width="15%" align="right"><spring:message code="network.netname"/>：</td>
						...
						<td><input type="text" id="expiredtime" name="expiredtime"
							...
							class="Wdate inp w150" value="${forcedrestart.expiredtime}"/>
							<span class="red"> *</span>
						</td>
					</tr>
					<tr height="25px">
					...
					<tr height="25px">
						...
						<td>
							<select id="network_match" name="network_match" class="select" style="width:157px;">
									<option value="0" <c:if test="${forcedrestart.network_match== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.match.0"/></option>
									<option value="1" <c:if test="${forcedrestart.network_match== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.match.1"/></option>
 							</select>
						</td>
						
						<td align="right"><spring:message code="authorize.forcedcc.network_id"/>：</td>
						<td>
					          <input type="text" class="inp" name="network_id" id="network_id" value="${forcedrestart.network_id}" maxlength="5" onkeyup="checkNum(this)" onkeypress="checkNum(this)" onblur="checkNum(this)" onafterpaste="this.value=this.value.replace(/\D/g,'')" /> 
						</td>
					</tr>
					<tr height="25px">
						...
						<td>
							<select id="operator_match" name="operator_match" class="select" style="width:157px;">
									<option value="0" <c:if test="${forcedrestart.operator_match== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.match.0"/></option>
									<option value="1" <c:if test="${forcedrestart.operator_match== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.match.1"/></option>
 							</select>
						</td>
						
						<td align="right"><spring:message code="authorize.forcedcc.operator_id"/>：</td>
						<td>
					          <input type="text" class="inp" name="operator_id" id="operator_id" value="${forcedrestart.operator_id}" maxlength="5"  onkeyup="checkNum(this)" onkeypress="checkNum(this)" onblur="checkNum(this)" onafterpaste="this.value=this.value.replace(/\D/g,'')" /> 
						</td>
					</tr>
					<tr height="25px">
						...
						<td>
							<select id="area_match" name="area_match" class="select" style="width:157px;">
									<option value="0" <c:if test="${forcedrestart.area_match== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.match.0"/></option>
									<option value="1" <c:if test="${forcedrestart.area_match== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.match.1"/></option>
 							</select>
						</td>
						
						<td align="right"><spring:message code="authorize.forcedcc.area_id"/>：</td>
						<td>
					          <input type="text" class="inp" name="area_id" id="area_id" value="${forcedrestart.area_id}" maxlength="5"  onkeyup="checkNum(this)" onkeypress="checkNum(this)" onblur="checkNum(this)" onafterpaste="this.value=this.value.replace(/\D/g,'')" /> 
						</td>
					</tr>
					<tr height="25px">
						...
						<td>
							<select id="device_type_match" name="device_type_match" class="select" style="width:157px;">
									<option value="0" <c:if test="${forcedrestart.device_type_match== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.match.0"/></option>
									<option value="1" <c:if test="${forcedrestart.device_type_match== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.match.1"/></option>
 							</select>
						</td>
						...
						<td>
					          <select id="device_type" name="device_type" class="select" style="width:157px;">
									<option value="0" <c:if test="${forcedrestart.device_type== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.device_type.0"/></option>
									<option value="1" <c:if test="${forcedrestart.device_type== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.device_type.1"/></option>
 							</select> 
						</td>
					</tr>
					<tr height="25px">
						...
						<td>
							<select id="terminal_type_match" name="terminal_type_match" class="select" style="width:157px;">
									<option value="0" <c:if test="${forcedrestart.terminal_type_match== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.match.0"/></option>
									<option value="1" <c:if test="${forcedrestart.terminal_type_match== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.match.1"/></option>
 							</select>
						</td>
						...
						<td>
					          <select id="terminal_type" name="terminal_type" class="select" style="width:157px;">
									<option value="0" <c:if test="${forcedrestart.terminal_type== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.terminal_type.0"/></option>
									<option value="1" <c:if test="${forcedrestart.terminal_type== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.terminal_type.1"/></option>
 							</select> 
						</td>
					</tr>
					<tr height="25px">
						...
						<td>
							<select id="vip_class_match" name="vip_class_match" class="select" style="width:157px;">
									<option value="0" <c:if test="${forcedrestart.vip_class_match== '0'}">selected</c:if>><spring:message code="authorize.forcedcc.match.0"/></option>
									<option value="1" <c:if test="${forcedrestart.vip_class_match== '1'}">selected</c:if>><spring:message code="authorize.forcedcc.match.1"/></option>
 							</select>
						</td>
						
						<td align="right"><spring:message code="authorize.forcedcc.vip_class"/>：</td>
						<td>
					         <input type="text" class="inp" name="vip_class" id="vip_class" value="${forcedrestart.area_id}" maxlength="5" onkeyup="checkNum(this)" onkeypress="checkNum(this)" onblur="checkNum(this)" onafterpaste="this.value=this.value.replace(/\D/g,'')" />
						</td>
					</tr>
					<tr>
						<td align="right" width="120px"><spring:message code="forcedrestart.restart.sign"/>：</td>
						<td>
							<select id="restartflag" name="restartflag" class="select" style="width:157px;">
									<option value="0" <c:if test="${forcedrestart.restartflag== '0'}">selected</c:if>><spring:message code="forcedrestart.restart.sign0"/></option>
									<option value="1" <c:if test="${forcedrestart.restartflag== '1'}">selected</c:if>><spring:message code="forcedrestart.restart.sign1"/></option>
 							</select>
						</td>
					</tr>
