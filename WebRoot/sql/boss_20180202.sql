...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='区域信息表';

-- ----------------------------
-- Records of area
-- ----------------------------
INSERT INTO `area` VALUES ('1', '1', null, '001000000000', '001000000000', '11', null);
...
CREATE TABLE `network` (
  ...
  `remark` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='网络信息表';

-- ----------------------------
-- Records of network
-- ----------------------------
INSERT INTO `network` VALUES ('1', '1', null, '1', '1', '1', null, null);
